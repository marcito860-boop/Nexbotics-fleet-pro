...
exports.calculateTemplateScore = exports.getScoreColor = exports.getScoreLabel = exports.getMaturityRating = exports.allAuditTemplates = exports.financialManagementCostControlQuestions = exports.environmentalSustainabilityQuestions = exports.dataManagementTelematicsQuestions = exports.riskManagementInsuranceQuestions = exports.complianceRegulatoryQuestions = exports.fuelManagementEfficiencyQuestions = exports.vehicleMaintenanceInspectionsQuestions = exports.driverManagementSafetyQuestions = exports.vehicleAcquisitionDisposalQuestions = exports.fleetPolicyGovernanceQuestions = void 0;
// =============================================================================
// TEMPLATE 1: FLEET POLICY & GOVERNANCE (10 Questions)
// =============================================================================
exports.fleetPolicyGovernanceQuestions = [
    {
        id: 'FPG-001',
...
// =============================================================================
exports.vehicleAcquisitionDisposalQuestions = [
    {
        id: 'VAD-001',
...
// =============================================================================
exports.driverManagementSafetyQuestions = [
    {
        id: 'DMS-001',
...
// =============================================================================
exports.vehicleMaintenanceInspectionsQuestions = [
    {
        id: 'VMI-001',
...
// =============================================================================
exports.fuelManagementEfficiencyQuestions = [
    {
        id: 'FME-001',
...
// =============================================================================
exports.complianceRegulatoryQuestions = [
    {
        id: 'CR-001',
...
// =============================================================================
exports.riskManagementInsuranceQuestions = [
    {
        id: 'RMI-001',
...
// =============================================================================
exports.dataManagementTelematicsQuestions = [
    {
        id: 'DMT-001',
...
// =============================================================================
exports.environmentalSustainabilityQuestions = [
    {
        id: 'ES-001',
...
// =============================================================================
exports.financialManagementCostControlQuestions = [
    {
        id: 'FMCC-001',
...
exports.allAuditTemplates = [
    {
        ...
        category: 'Governance',
        questions: exports.fleetPolicyGovernanceQuestions
    },
    {
        ...
        questions: exports.vehicleAcquisitionDisposalQuestions
    },
    {
        ...
        category: 'Safety',
        questions: exports.driverManagementSafetyQuestions
    },
    {
        ...
        category: 'Operations',
        questions: exports.vehicleMaintenanceInspectionsQuestions
    },
    {
        ...
        category: 'Operations',
        questions: exports.fuelManagementEfficiencyQuestions
    },
    {
        ...
        category: 'Compliance',
        questions: exports.complianceRegulatoryQuestions
    },
    {
        ...
        category: 'Risk',
        questions: exports.riskManagementInsuranceQuestions
    },
    {
        ...
        category: 'Technology',
        questions: exports.dataManagementTelematicsQuestions
    },
    {
        ...
        questions: exports.environmentalSustainabilityQuestions
    },
    {
        ...
        category: 'Finance',
        questions: exports.financialManagementCostControlQuestions
    }
];
// =============================================================================
// HELPER FUNCTIONS
// =============================================================================
const getMaturityRating = (totalScore) => {
    if (totalScore >= 170) {
        return {
            rating: 'World Class',
            color: '#10B981',
...
exports.getMaturityRating = getMaturityRating;
...
const calculateTemplateScore = (responses) => {
    const totalScore = responses.reduce((sum, r) => sum + (r.score || 0), 0);
    const maxScore = responses.length * 2;
    const percentage = maxScore > 0 ? Math.round((totalScore / maxScore) * 100) : 0;
    return { totalScore, maxScore, percentage };
};
exports.calculateTemplateScore = calculateTemplateScore;
exports.default = exports.allAuditTemplates;
//# sourceMappingURL=auditTemplates.js.map