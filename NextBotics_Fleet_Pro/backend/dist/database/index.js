    ...
    if (pool) {
        try {
            ...
            if (adminResult.rows.length === 0) {
                ...
                await pool.query('INSERT INTO users (id, email, password_hash, role, first_name, last_name) VALUES ($1, $2, $3, $4, $5, $6)', [(0, uuid_1.v4)(), 'admin@fleet.local', hashedPassword, 'admin', 'Admin', 'User']);
