...
router.get('/stats', async (req, res) => {
    try {
        // Fleet overview
        const fleetStats = await (0, database_1.query)(`
      SELECT 
    ...
    `);
        // Staff count
        const staffStats = await (0, database_1.query)('SELECT COUNT(*) as total_staff FROM staff');
        // Today's routes - PostgreSQL syntax
        const todayRoutes = await (0, database_1.query)(`
    ...
    `);
        ...
        const monthlyFuel = await (0, database_1.query)(`
    ...
    `);
        // Pending repairs
        const repairsStats = await (0, database_1.query)(`
    ...
    `);
        ...
        const topConsumers = await (0, database_1.query)(`
