...
import { 
  Building2, Bell, User, Shield, Globe, Database, Palette, 
  Save, RefreshCw, Check, X, Lock, Mail, Phone, 
  MapPin, FileText, Users, Truck,
...
function CompanySettingsTab({ API_BASE_URL, token, onSave, saving, setSaving }: {
  API_BASE_URL: string;
  token: string;
...
function FleetSettingsTab({ API_BASE_URL, token, onSave, saving, setSaving }: {
  API_BASE_URL: string;
  token: string;
  onSave: (type: 'success' | 'error', msg: string) => void;
  saving: boolean;
...
function NotificationsTab({ API_BASE_URL, token, onSave, saving, setSaving }: {
  API_BASE_URL: string;
  token: string;
  onSave: (type: 'success' | 'error', msg: string) => void;
  saving: boolean;
...
function UserPreferencesTab({ API_BASE_URL, token, onSave, saving, setSaving }: {
  API_BASE_URL: string;
  token: string;
  onSave: (type: 'success' | 'error', msg: string) => void;
  saving: boolean;
...
function SecuritySettingsTab({ API_BASE_URL, token, onSave, saving, setSaving }: {
  API_BASE_URL: string;
  token: string;
  onSave: (type: 'success' | 'error', msg: string) => void;
  saving: boolean;
